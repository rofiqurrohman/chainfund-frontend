...
const buttonVariants = cva(
    "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
    {
        variants: {
            variant: {
                default:
                    "bg-[hsl(var(--primary))] text-white shadow hover:bg-[hsl(var(--primary))]/90 hover:shadow-lg hover:-translate-y-0.5",
                destructive:
                    "bg-[hsl(var(--destructive))] text-white shadow-sm hover:bg-[hsl(var(--destructive))]/90",
                outline:
                    "border border-[hsl(var(--border))] bg-transparent shadow-sm hover:bg-[hsl(var(--muted))] hover:text-[hsl(var(--foreground))]",
                secondary:
                ...
                gradient:
                    "gradient-primary text-white shadow hover:shadow-lg hover:-translate-y-0.5",
            },
            size: {
