            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="md:col-span-1">
                        ...
                        <p className="text-sm text-[hsl(var(--muted-foreground))] leading-relaxed">
                            Platform crowdfunding RWA untuk investasi UMKM Indonesia dengan transparansi blockchain.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-[hsl(var(--muted-foreground))]">
                            <li>
                                <Link to="/projects" className="hover:text-[hsl(var(--foreground))] transition-colors">
                                    Marketplace
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link to="/" className="hover:text-[hsl(var(--foreground))] transition-colors">
                                    How It Works
                                </Link>
                            </li>
                        </ul>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="text-sm text-[hsl(var(--muted-foreground))]">
                        © 2026 ChainFund. All rights reserved.
                    </p>
