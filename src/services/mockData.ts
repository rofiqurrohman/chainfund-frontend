import type { Project, Investment, User, EarningsData, Transaction } from '@/types';

// ===== Mock Projects =====
export const mockProjects: Project[] = [
  // {
  //   id: 'd775d811-497d-41d7-b32f-cdc945bb7ada',
  //   // user_id: '618a65de-0e02-4c52-a908-e996710f7375',
  //   name: 'Warung Testing',
  ...
  //   remaining_days: 30,
  //   image_url:
  //     'https://img.freepik.com/foto-gratis/karakter-penjaga-toko-kartun-3d_1048-16764.jpg?t=st=1769585186~exp=1769588786~hmac=b2dfc7c9cf734c89b45022646dfd93c9f62217d70f8aab1cea00cf0b4e3228c0&w=1480',
  //   is_active: true,
  //   is_funded: false,
  //   contract_address: '0xc8c7B20892Bf8D9776a3B4d064D9Fb1337cd54cb',
  //   monthly_revenue: null,
  //   monthly_expenses: null,
  //   net_profit: null,
  //   profit_margin: null,
  //   business_age: null,
  //   created_at: '2026-01-30 06:05:58.377316+00',
  //   updated_at: '2026-01-31 01:39:48.071976+00',
  // },
  {
    id: '1',
    ...
    updates: [
      {
        ...
        content: 'Kami telah menandatangani kontrak sewa untuk lokasi pertama di Kemang, Jakarta Selatan.',
      },
    ],
    financialDetails: {
    ...
    updates: [
      {
        ...
        content: 'Terima kasih kepada semua investor. Proyek akan segera dimulai bulan depan.',
      },
    ],
    financialDetails: {
    ...
    updates: [
      {
        ...
        content: '5 lokasi pertama sudah beroperasi dengan rata-rata 200 order per hari.',
      },
    ],
    financialDetails: {
