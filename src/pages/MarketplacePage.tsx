...
export function MarketplacePage() {
    ...
    const industries: Industry[] = ['F&B', 'Retail', 'Agriculture', 'Technology', 'Manufacturing', 'Services', 'Healthcare', 'Education'];
    ...
    const filteredProjects = useMemo(() => {
        ...
        let result = data.fundings.map(transformToProject);
                            ...
                            <>
                                <div className="mb-6">
                                    <p className="text-sm text-[hsl(var(--muted-foreground))]">
                                        Showing <span className="font-medium text-[hsl(var(--foreground))]">{filteredProjects.length}</span> project{filteredProjects.length !== 1 && 's'}
                                    </p>
                                </div>
